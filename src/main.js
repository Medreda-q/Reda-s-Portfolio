...
const translations = {
  en: {
    ...
    "project.portfolioTitle": "Portfolio & Web CV",
    "project.portfolio": "This portfolio was built with a futuristic aesthetic, responsive design, and multi-language support (EN/FR/ES). It also includes a trilingual online CV built with Hugo.",
  ...
  fr: {
    ...
    "project.snortTitle": "SNORT IDS/IPS",
    "project.portfolioTitle": "Portfolio & CV en Ligne",
    "project.portfolio": "Ce portfolio construit avec une esthétique futuriste, un design responsive et un support multilingue (EN/FR/ES), incluant également un CV en ligne trilingue construit avec Hugo.",
  ...
  es: {
    ...
    "project.snortTitle": "SNORT IDS/IPS",
    "project.portfolioTitle": "Portfolio & CV en Línea",
    "project.portfolio": "Este portafolio construido con una estética futurista, diseño responsivo y soporte multilingüe (EN/FR/ES), incluyendo además un CV en línea trilingüe construido con Hugo.",
