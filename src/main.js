...
const translations = {
  en: {
    ...
    "hero.greeting": "Hi, I'm Mohamed Reda",
    "about.greeting": "Hey!",
    ...
    "portfolio.viewProject": "VIEW WEBSITE",
    ...
    "project.snortTitle": "SNORT IDS/IPS",
    "project.portfolioTitle": "CyberStorm Club",
    "project.portfolio": "Developed the official website for the CyberStorm cybersecurity club as a member of its administrative and technical team, to showcase club activities, capture interest, and share resources.",
    ...
    "impossible.intro1": "You might be wondering what an impossible list is and why it is here. In contrast with a bucket list, an impossible list is ever evolving and is expected to grow with time: you might cross things off the list, but you are also <strong>always adding new items</strong> to the list. It is, therefore, <em>impossible</em> to finish every single item in the list, hence the name.",
    "impossible.intro2": "I'm keeping my list public to encourage myself to update it and to get other people to start their very own lists as well.",
  ...
  fr: {
    ...
    "hero.greeting": "Bonjour, je suis Mohamed Reda",
    ...
    "portfolio.viewProject": "VOIR LE SITE WEB",
    ...
    "project.snortTitle": "SNORT IDS/IPS",
    "project.portfolioTitle": "Club CyberStorm",
    "project.portfolio": "Développement du site web officiel du club de cybersécurité CyberStorm en tant que membre de son équipe administrative et technique, afin de présenter les activités du club, susciter l'intérêt et partager des ressources.",
    ...
    "impossible.by": "par Mohamed Reda Qiyaoui",
    "impossible.intro1": "Vous vous demandez peut-être ce qu'est une liste impossible et pourquoi elle est ici. Contrairement à une liste de choses à faire avant de mourir, une liste impossible est en constante évolution et est censée s'allonger avec le temps : vous pouvez cocher des éléments, mais vous <strong>ajoutez toujours de nouveaux éléments</strong> à la liste. Il est donc <em>impossible</em> de compléter chaque élément, d'où le nom.",
    "impossible.intro2": "Je garde ma liste publique pour m'encourager à la mettre à jour et pour inciter d'autres personnes à démarrer leurs propres listes.",
  ...
  es: {
    ...
    "hero.greeting": "Hola, soy Mohamed Reda",
    "about.greeting": "¡Hola!",
    ...
    "portfolio.viewProject": "VER SITIO WEB",
    ...
    "project.snortTitle": "SNORT IDS/IPS",
    "project.portfolioTitle": "Club CyberStorm",
    "project.portfolio": "Desarrollo del sitio web oficial del club de ciberseguridad CyberStorm como miembro de su equipo administrativo y técnico, con el fin de mostrar las actividades del club, despertar interés y compartir recursos.",
    ...
    "impossible.by": "por Mohamed Reda Qiyaoui",
    "impossible.intro1": "Puede que te preguntes qué es una lista imposible y por qué está aquí. A diferencia de una lista de deseos, una lista imposible está en constante evolución y se espera que crezca con el tiempo: puedes tachar cosas de la lista, pero también estás <strong>siempre añadiendo nuevos elementos</strong>. Por lo tanto, es <em>imposible</em> completar cada elemento de la lista, de ahí el nombre.",
    "impossible.intro2": "Mantengo mi lista pública para animarme a actualizarla y para que otras personas empiecen sus propias listas.",
