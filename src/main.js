...
const translations = {
  en: {
    ...
    "timeline.dotaskTitle": "DoTask — Full-Stack Task Manager",
    "timeline.dotaskDesc": "Developed a premium full-stack task management web application using ReactJS (TypeScript, TailwindCSS, Zustand, React Query) and Flask (Python, SQLite, SQLAlchemy). Implemented secure Google OAuth, email password recovery via Resend, and a fully documented REST API with JWT authentication.",
    "timeline.dotaskDate": "December 2025",
  ...
  fr: {
    ...
    "timeline.dotaskTitle": "DoTask — Gestionnaire de tâches Full-Stack",
    "timeline.dotaskDesc": "Développement d'une application web de gestion de tâches premium avec ReactJS (TypeScript, TailwindCSS, Zustand, React Query) et Flask (Python, SQLite, SQLAlchemy). Intégration de Google OAuth, récupération de mot de passe par e-mail via Resend, et une API REST documentée avec JWT.",
    "timeline.dotaskDate": "Décembre 2025",
    "timeline.dutTitle": "Cybersécurité et audit des systèmes d'information",
  ...
  es: {
    ...
    "timeline.dotaskTitle": "DoTask — Gestor de tareas Full-Stack",
    "timeline.dotaskDesc": "Desarrollo de una aplicación web premium de gestión de tareas utilizando ReactJS (TypeScript, TailwindCSS, Zustand, React Query) y Flask (Python, SQLite, SQLAlchemy). Integración de Google OAuth, recuperación de contraseña por correo electrónico mediante Resend y una API REST documentada con JWT.",
    "timeline.dotaskDate": "Diciembre 2025",
