...
const translations = {
  en: {
    ...
    "project.cv": "Trilingual (EN/FR/ES) online CV built with Hugo, cloning the design of cv.diogotc.com with personal info, skills and projects.",
    "project.wazuhTitle": "Attack Simulation",
    "project.wazuh": "Attack simulation and threat detection using Wazuh, pfSense, and Suricata.",
    ...
    "impossible.cyber.3": "Reach top 100 in a major CTF platform",
  ...
  fr: {
    ...
    "project.cv": "CV trilingue (EN/FR/ES) construit avec Hugo, reprenant le design de cv.diogotc.com avec mes informations, compétences et projets.",
    "project.wazuhTitle": "Simulation d'Attaque",
    "project.wazuh": "Simulation d'attaque et détection des menaces utilisant Wazuh, pfSense et Suricata.",
    ...
    "impossible.cyber.3": "Atteindre le top 100 sur une plateforme CTF majeure",
  ...
  es: {
    ...
    "project.cv": "CV trilingüe (EN/FR/ES) construido con Hugo, replicando el diseño de cv.diogotc.com con mi información personal, habilidades y proyectos.",
    "project.wazuhTitle": "Simulación de Ataque",
    "project.wazuh": "Simulación de ataque y detección de amenazas usando Wazuh, pfSense y Suricata.",
    ...
    "impossible.cyber.3": "Alcanzar el top 100 en una plataforma de CTF importante",
