...
const translations = {
  en: {
    ...
    "timeline.dotaskDesc": "Developed a premium, AI-integrated full-stack task management web application using ReactJS (TypeScript, TailwindCSS, Zustand, React Query) and Flask (Python, SQLite, SQLAlchemy). Built with intelligent features to make task management easier, secure Google OAuth, email password recovery, and a fully documented REST API with JWT authentication.",
  ...
  fr: {
    ...
    "timeline.dotaskDesc": "Développement d'une application web de gestion de tâches premium avec intégration IA pour faciliter la gestion des tâches, utilisant ReactJS (TypeScript, TailwindCSS, Zustand, React Query) et Flask (Python, SQLite, SQLAlchemy). Comprend Google OAuth, la récupération par e-mail et une API REST documentée avec JWT.",
  ...
  es: {
    ...
    "timeline.dotaskDesc": "Desarrollo de una aplicación web premium de gestión de tareas con integración de IA para facilitar la organización de tareas, utilizando ReactJS (TypeScript, TailwindCSS, Zustand, React Query) y Flask (Python, SQLite, SQLAlchemy). Incluye Google OAuth, recuperación por correo y una API REST documentada con JWT.",
